...
public class ImageUtil {
	...
	/**
	 * Uses Apache's commons.codec library
	 ...
	 * @return
	 */
	public File loadImage (String fileName)  throws IOException{
        File f = new File(defaultDestPath,fileName);
        if(!f.exists()){
